# License Audit — GONGPO-DONGGUNG PRO

- **commercial_safe: `false`**
- 정책: source별 개별 license. 전역 license 가정 금지. unknown/to_verify/제4유형 사용 시 commercial_safe=false.
- 소스별 license는 개별 확인한다. 전역 license 가정은 없다.
- 보고서 이미지·PDF 페이지·발굴 사진은 public viewer로 복사하지 않는다 (V20).
...
| khs_2025_silla_capital_10year_outcome | P1 | to_verify | false | unverified | true | false | true |
| nrich_donggung_wolji_iii_report | P1 | 공공누리 제4유형 가능성 있음 - 공식 페이지에서 확정 | false | declared_unverified | false | false | true |
...
- **khs_2025_silla_capital_10year_outcome**: license 미확인. 확인 전까지 상업/공개 파생 사용 불가.
- **nrich_donggung_wolji_iii_report**: license 미확인. 확인 전까지 상업/공개 파생 사용 불가.
